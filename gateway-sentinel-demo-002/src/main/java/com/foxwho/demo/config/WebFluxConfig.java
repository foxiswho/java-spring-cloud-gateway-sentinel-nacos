...
import com.foxwho.demo.exception.JsonSentinelGatewayBlockExceptionHandler;
...
public class WebFluxConfig {
    ...
    @Bean
    @Order(-1)
    public JsonSentinelGatewayBlockExceptionHandler sentinelBlockExceptionHandler() {
